...
class FirebaseBakeryService {
  ...
  async seedFirestoreDatabase() {
    ...
    const products = [
      ...
      {
        name: 'Chakote Family Pack Butter Toast',
        category: 'Toast & Khari',
        description: 'Crispy, oven-baked family pack butter toast rusks made with pure premium butter and golden wheat.',
        price: 75.0,
        unit: 'packet',
        quantity: 100,
        low_stock_threshold: 20,
      ...
      {
        name: 'Red Velvet Heart Birthday Cake (500g)',
        category: 'Cakes & Pastries',
        description: 'Classic crimson red velvet sponge layered with smooth cream cheese frosting and white chocolate curls.',
        price: 420.0,
        unit: 'piece',
        quantity: 10,
        low_stock_threshold: 3,
        image_url: 'https://images.unsplash.com/photo-1588195538326-c5b1e9f80a1b?w=600',
        available_from: '08:00 AM',
        available_until: '10:00 PM',
      },
      {
        name: 'Chakote Fresh Burger Buns (Pack of 4)',
        category: 'Bread & Pav',
        description: 'Soft, pillowy sesame-topped burger buns baked fresh daily at our Sangola oven.',
        price: 25.0,
        unit: 'packet',
        quantity: 80,
        low_stock_threshold: 15,
