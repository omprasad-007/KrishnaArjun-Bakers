    ...
    <div className="py-10 px-4 max-w-lg mx-auto space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-gray-500">
          Create your account with email for fresh Sangola bakery orders & live tracking
        </p>
      </div>
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#dac2b6]/40 shadow-warm-md space-y-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            <div>
              ...
              <input
                ...
                className="w-full p-2 rounded-xl border border-[#dac2b6]/60 bg-[#fcf9f8] focus:bg-white focus:outline-none font-medium text-xs"
              />
            </div>
            <div>
        ...
        <div className="text-center text-xs text-gray-500 pt-2 border-t border-[#f0eded]">
          Already have an account?{' '}
          <Link to={`/login?redirect=${redirectPath}`} className="font-bold text-[#8b4513] hover:underline">
            Sign In with Email
          </Link>
        </div>
      </div>
